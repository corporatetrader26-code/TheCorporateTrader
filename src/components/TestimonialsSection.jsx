...
export default function TestimonialsSection() {
  return (
    <section className="relative w-full py-24 overflow-hidden text-center">
      ...
      {/* ✅ Viewport container to prevent overflow */}
      <div className="w-full max-w-[1400px] mx-auto overflow-hidden">

        {/* ✅ Marquee track is TIGHT and centered */}
        <div className="flex gap-8 animate-marquee-left whitespace-nowrap will-change-transform">

          {[...testimonials, ...testimonials].map((t, index) => (
            <div
              key={index}
              className="w-[300px] md:w-[360px] inline-block bg-gradient-to-br from-[#161616] to-[#0d0d0d]
              border border-white/10 rounded-2xl p-8 shadow-xl text-left"
            >
